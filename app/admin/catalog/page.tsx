                ...
                <div className="w-full max-w-lg rounded-2xl overflow-hidden" style={glass}>
                        ...
                        <div className="p-5 space-y-4 max-h-[75vh] overflow-y-auto">
                                  ...
                                  <div className="flex flex-wrap items-center gap-3">
                                    ...
                                    {uploadMsg && <span className="font-mono text-xs text-green-400">{uploadMsg}</span>span>}
                      ...
                      <div className="font-mono text-[10px] text-amber/70">Design file: {form.file_name}</div>
                            ...
                            <div>
                                        <label className="font-mono text-[10px] text-steel/60 block mb-1">TITLE</label>label>
                          ...
                          <div className="flex items-center gap-4">
                                      <div className="flex-1">
                                                    <label className="font-mono text-[10px] text-steel/60 block mb-1">SORT ORDER</label>label>
