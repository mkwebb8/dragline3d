...
export const MATERIALS = {
  PLA:       { label: "PLA",        desc: "General purpose",           costPerKg: 13,   swatch: "#e8e6e1", density: 1.24 },
  PETG:      { label: "PETG",       desc: "Tough, weather resistant",  costPerKg: 13.5, swatch: "#c8d4d1", density: 1.27 },
  TPU:       { label: "TPU",        desc: "Flexible, shock absorbing", costPerKg: 20,   swatch: "#3a3a3c", density: 1.21 },
  ...
  PC:        { label: "PC",         desc: "Polycarbonate, extreme strength", costPerKg: 25, swatch: "#a8a8ac", density: 1.20 },
  PA:        { label: "PA (Nylon)", desc: "Wear-resistant, load-bearing", costPerKg: 25, swatch: "#d4cfb5", density: 1.14 },
  "PLA-CF":  { label: "PLA-CF",    desc: "Carbon-reinforced PLA",      costPerKg: 35,   swatch: "#1a1a1c", density: 1.30 },
  "PETG-CF": { label: "PETG-CF",   desc: "Carbon-reinforced PETG (Fiberon)", costPerKg: 40, swatch: "#1a1a1c", density: 1.31 },
  "PA-CF":   { label: "PA-CF",     desc: "Carbon-reinforced nylon (Fiberon)", costPerKg: 70, swatch: "#1a1a1c", density: 1.18 },
} as const;
